...
import { pagePathFields } from '../../directus/page';
...
/**
 * Fetches published tour data from Directus
 * @param filters - Request filters including locale, category, subCategory, article
 * @returns Tour data or null if not found/invalid
 */
