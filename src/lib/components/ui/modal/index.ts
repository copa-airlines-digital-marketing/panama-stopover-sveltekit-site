...
const modalVariants = cmTailwindVariants({
  base: 'fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 min-h-80 md:min-h-96 max-h-[67%] w-full max-w-[90%] bg-backgound-paper pt-11 rounded-lg',
  variants: {
    size: {
      narrow: 'pb-10 sm:max-h-[576px] md:max-h-[87%] lg:max-h-[72%] sm:max-w-[392px]',
      normal: 'pb-11 sm:max-h-[87%] lg:max-h-[72%] sm:max-w-[560px] md:max-w-[600px] lg:max-w-[798px]',
